...
// Идентификатор сотрудника
 ...
 public Author(String firstName, String lastName, String middleName, Integer raiting,String phone,String email, Long idBook) {
	 this.firstName = firstName;
	 this.lastName = lastName;
	 this.middleName = middleName;
	 this.raiting = raiting;
 ...
 public Author(Long id, String firstName, String lastName, String middleName, Integer raiting,String phone,String email, Long idBook) {
	 this.id = id;
	 this.firstName = firstName;
	 this.lastName = lastName;
	 this.middleName = middleName;
