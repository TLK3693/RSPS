					...
					<form method="POST" action="">
						...
						<div class="mb-3 row">
							...
							<div class="col-sm-6">
								<input type="text" class="form-control" 
									value="${rolesEdit[0].getId()}" /> <!-- readonly -->
							</div>
						</div>
						...
						<div class="mb-3 row">
							<label for="inputPereplet" class="col-sm-3 col-form-label">
								Тип переплёта</label>
							<div class="col-sm-6">
								<input type="text" class="form-control" name="inputPereplet"
									value="${roleEdit.getPereplet()}" id="personPereplet"  />
							</div>
						</div>
						<div class="mb-3 row">
							<label for="inputIzdatelstvo" class="col-sm-3 col-form-label">
								Издательство</label>
							<div class="col-sm-6">
								<input type="text" class="form-control" name="inputIzdatelstvo"
									value="${roleEdit.getIzdatelstvo()}" id="personIzdatelstvo" />
							</div>
						</div>
						<div class="mb-3 row">
							<label for="inputYearOfBirth" class="col-sm-3 col-form-label">
								Год</label>
							<div class="col-sm-6">
								<input type="text" class="form-control" name="inputYearOfBirth"
									value="${roleEdit.getYearOfBirth()}" id="personYearOfBirth" />
							</div>
						</div>
						<div class="mb-3 row">
							<label for="inputGenre" class="col-sm-3 col-form-label">
								Жанр</label>
							<div class="col-sm-6">
								<input type="text" class="form-control" name="inputGenre"
									value="${roleEdit.getGenre()}" id="personGenre"  />
							</div>
						</div>
						<p>
							<br> <br> <br>
