...
Author p1 = new Author(1l, "Иван", "Иванов", "Иванов", 1, "+7 (961)-289-55-24", "ivanov@mail.ru", 1l, r1);
Author p2 = new Author(2l, "Петр", "Петров", "Иванов", 2, "+7 (961)-289-44-39", "ivanov@mail.ru", 2l, r2);
Author p3 = new Author(3l, "Сидор", "Сидоров", "Иванов", 3, "+7 (961)-289-33-57", "ivanov@mail.ru", 3l, r3);
Author p4 = new Author(4l, "Иван", "Иванов", "Иванов", 4, "+7 (961)-289-44-39", "ivanov@mail.ru", 4l, r4);
Author[] persons = new Author[] { p1, p2, p3, p4 };
