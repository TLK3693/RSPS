		...
		<div class="container">
			...
			<div class="list-group text-center py-3 px-3">
				...
				<ul class="list-group list-group-flush">
					<li class="list-group-item list-group-itemprimary"><a
						href="/persons/views/author.jsp">Авторы</a></li>
					<li class="list-group-item list-group-iteminfo"><a
						href="/persons/views/book.jsp">Книги</a></li>
				</ul>
			</div>
			<br>
			<br>
